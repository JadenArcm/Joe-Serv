...
local function drawNotification(v)
	...
	v.drawString(x, anim, "The level will either \x85" .. "restart" .. "\x80 or \x85" .. "skip" .. "\x80 after \x82" .. joeVars.autoExit.value .. "\x80 minutes.", V_ALLOWLOWERCASE | flags, "thin-fixed-center")
